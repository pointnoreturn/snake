...
func (r *Socket) GetChannels() (channels []*pb.Channel, err error) {
...
// GetChannelInfo returns the current chanels settings for the radio
func (r *Socket) GetChannelInfo(index int) (channelSettings *pb.Channel, err error) {
...
func (r *Socket) SetChannelURL(url string) error {
...
func (r *Socket) AddChannel(name string, cIndex int) error {
...
func (r *Socket) SetChannel(chIndex int, key string, value string) error {
...
func (r *Socket) DeleteChannel(cIndex int) error {
