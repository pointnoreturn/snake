...
func (r *Socket) GetRadioConfig() (configPackets []*pb.FromRadio_Config, modulePackets []*pb.FromRadio_ModuleConfig, err error) {
...
func (r *Socket) SetRadioConfig(key string, value string) error {
...
func sendAdminMessage(adminPacket pb.AdminMessage, r *Socket) error {
